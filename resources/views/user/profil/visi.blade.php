...
<section class="profile-section">
    <div class="container konten-profil text-center">
        ...
        <div class="box-visi">
            {{ $profil->visi ?: 'TERWUJUDNYA KECAMATAN NONGSA SEBAGAI TUJUAN WISATA BERBUDAYA DAN RELIGIUS DENGAN APARATUR PEMERINTAHAN YANG PROFESIONAL DAN BERAHLAK MULIA.' }}
        </div>
