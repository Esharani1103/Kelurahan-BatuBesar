    ...
    <div class="profil-umum">
        ...
        <div class="profil-umum-grid">
            <div class="profil-umum-text">
                <h2>Mengenal Kelurahan Batu Besar</h2>
                <p>
                ...
                <p>
                    Kelurahan Batu Besar terletak di salah satu dari 4 kelurahan yang ada di
                    Kecamatan Nongsa, Kota Batam. Kelurahan ini berbatasan langsung dengan
                    perairan Selat Malaka di sebelah utara.
                </p>
                <p>
                    Dengan luas wilayah sekitar 12 km², kelurahan ini terdiri dari 6 RW dan
                    24 RT yang tersebar di beberapa kampung bersejarah.
                </p>
            </div>
